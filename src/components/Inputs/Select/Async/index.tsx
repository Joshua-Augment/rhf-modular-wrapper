...
import { IFormFrameInjector, InputWrapper, TSelectOption, ISelectAsync } from '../../../core'
...
interface ISelectWrapper extends IFormFrameInjector<TSelectOption|null>,ISelectAsync {
...
const SelectWrapper = (props: ISelectWrapper) => {
  ...
  return props.isCreateable !== undefined ? 
   <AsyncCreatableSelectInput onCreateOption={createNew} {...props} options={options} isDisabled={props.rsOptions?.isDisabled ?? props.disabled ?? false} value={selectedOption} onChange={onChangeHandler} {...props.rsOptions} />: 
   <AsyncSelectInput {...props} options={options} isDisabled={props.rsOptions?.isDisabled ?? props.disabled ?? false} value={selectedOption} onChange={onChangeHandler} {...props.rsOptions} />
}
