...
export const Lines = () => {
  return <Form onSubmit={onSubmit} >
    <Line label="Simple Form Input (Text)" name="lines.text" placeholder="Simple Form Placeholder" inputWrapper={InputWrapper} helperText="I have a custom body!" />
    <Line label="Simple Form Input (Number)" name="lines.number" placeholder="Simple Number Placeholder" type="number" helperText="I'm using the default style!"/>
