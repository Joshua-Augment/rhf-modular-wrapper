...
const InputWrapper = (props) => {
    ...
    const _v = (0, useInputValnError_1.useInputValAndError)(props.name), { value, error } = _v, rest = __rest(_v, ["value", "error"]);
