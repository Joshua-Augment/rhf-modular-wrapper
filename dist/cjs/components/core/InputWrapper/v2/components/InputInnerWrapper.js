...
var InputInnerWrapper = function (props) {
    ...
    Logger_1.default.info("First Update : ".concat(firstUpdate.current), "".concat(_propsName, " - InputWrapperv2"));
    ...
    Logger_1.default.info("Watching Calculated : ".concat(String(watchCalculated)), "".concat(_propsName, " - InputWrapperv2"));
    // console.log(`For ${props.name}, error : `,rest.error)
    // On Value change
    (0, react_1.useEffect)(function () {
        Logger_1.default.info("Default Value : ".concat(String(props.defaultValue)), "".concat(_propsName, " - InputWrapperv2"));
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (props.externalStateSetter) {
            Logger_1.default.info("Setting External State", "".concat(_propsName, " - InputWrapperv2"));
            props.externalStateSetter(value);
        }
        // On Input Change
        if (props.onInputChange && !firstUpdate.current) {
            Logger_1.default.info("First Time Setting", "".concat(_propsName, " - InputWrapperv2"));
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (props.calculatedField) {
            Logger_1.default.info("Setting External State", "".concat(_propsName, " - calculatedField"), "start");
            if (props.calculatedField.isPromise === true) {
                Logger_1.default.info("Promise expected", "".concat(_propsName, " - calculatedField"));
                props.calculatedField
                    ...
                    .then(function (data) {
                    Logger_1.default.info("Calculated Data : ".concat(String(data)), "".concat(_propsName, " - calculatedField"));
                ...
                Logger_1.default.info("No Promise expected. Value Expected : ".concat(String(_result)), "".concat(_propsName, " - calculatedField"));
    ...
    Logger_1.default.info("Setting Left Wrapper", "".concat(_propsName, " - InputWrapperv2"));
    ...
    Logger_1.default.info("Setting Right Wrapper", "".concat(_propsName, " - InputWrapperv2"));
    ...
    Logger_1.default.info("Setting Chosen Element", "".concat(_propsName, " - InputWrapperv2"));
    ...
    var ChildComponent = ((0, jsx_runtime_1.jsxs)(react_1.default.Fragment, { children: [WrapperElementLeft, ChosenElement
                ...
                : react_1.default.cloneElement(props.children, __assign(__assign(__assign({}, (_p = props.children) === null || _p === void 0 ? void 0 : _p.props), methods), { disabled: props.disabled, type: (_q = props === null || props === void 0 ? void 0 : props.type) !== null && _q !== void 0 ? _q : "line", onChange: function (a) {
                        var _a, _b;
                        return methods.setValue(props.name, a, {
                            shouldValidate: (_a = props.shouldValidateOnChange) !== null && _a !== void 0 ? _a : false,
                            shouldDirty: (_b = props.shouldDirtyOnChange) !== null && _b !== void 0 ? _b : false,
