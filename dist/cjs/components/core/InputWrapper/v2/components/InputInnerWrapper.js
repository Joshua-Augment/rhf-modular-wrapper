...
var InputInnerWrapper = function (props) {
    ...
    index_1.default.info("First Update : ".concat(firstUpdate.current), "".concat(_propsName, " - InputWrapperv2"));
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (props.externalStateSetter) {
            index_1.default.info("Setting External State", "".concat(_propsName, " - InputWrapperv2"));
            props.externalStateSetter(value);
        }
        // On Input Change
        if (props.onInputChange && !firstUpdate.current) {
            index_1.default.info("First Time Setting", "".concat(_propsName, " - InputWrapperv2"));
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (props.calculatedField) {
            index_1.default.info("Setting External State", "".concat(_propsName, " - calculatedField"), "start");
            if (props.calculatedField.isPromise === true) {
                index_1.default.info("Promise expected", "".concat(_propsName, " - calculatedField"));
                props.calculatedField
                    ...
                    .then(function (data) {
                    index_1.default.info("Calculated Data : ".concat(String(data)), "".concat(_propsName, " - calculatedField"));
                ...
                index_1.default.info("No Promise expected. Value Expected : ".concat(String(_result)), "".concat(_propsName, " - calculatedField"));
    ...
    index_1.default.info("Setting Left Wrapper", "".concat(_propsName, " - InputWrapperv2"));
    var WrapperElementLeft = (0, react_1.useMemo)(function () {
        var _a, _b, _c, _d, _e, _f;
        index_1.default.info("useMemo", "WrapperElementLeft", "start");
        index_1.default.info(null, null, "end");
    ...
    index_1.default.info("Setting Right Wrapper", "".concat(_propsName, " - InputWrapperv2"));
    var WrapperElementRight = (0, react_1.useMemo)(function () {
        var _a, _b, _c, _d, _e, _f;
        index_1.default.info("useMemo", "WrapperElementRight", "start");
        index_1.default.info(null, null, "end");
    ...
    index_1.default.info("Setting Chosen Element", "".concat(_propsName, " - InputWrapperv2"));
