...
const Select = (props) => {
    ...
    return (0, jsx_runtime_1.jsx)(InputWrapper_1.default, Object.assign({ type: (_a = props.type) !== null && _a !== void 0 ? _a : 'select' }, props, { noBorder: true }, { children: (0, jsx_runtime_1.jsx)(_Select, Object.assign({}, _props)) }));
};
const _Select = (props) => {
