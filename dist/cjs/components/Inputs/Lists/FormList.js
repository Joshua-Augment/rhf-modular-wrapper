...
var FormList = function (props) {
    ...
    (0, react_1.useEffect)(function () { if (fields.length === 0) {
        append(emptyRow);
    } }, []);
    var bodygenerator = (0, react_1.useMemo)(function () {
        ...
        return fields.map(function (field, i) {
            ...
            if (props.bodyTemplate !== undefined) {
                ...
                return (0, jsx_runtime_1.jsxs)(Row, { children: [props.showIndex === true && (0, jsx_runtime_1.jsx)(Col, __assign({ g: 1 }, { children: i + 1 })), props.items.map(function (item, iT) { var _a; return (0, jsx_runtime_1.jsx)(Col, __assign({ g: (_a = item.grid) !== null && _a !== void 0 ? _a : 12 / (props.items.length + (props.showIndex ? 1 : 0) + (props.fixed !== true ? 1 : 0)) }, { children: (0, jsx_runtime_1.jsx)(InputChooser_1.default, __assign({}, item, { noBorder: true, name: "".concat(props.name, ".").concat(i, ".").concat(item.name) })) }), "fw-".concat(props.name, "-").concat(i, "-").concat(iT, "-iew")); }), props.fixed !== true && (0, jsx_runtime_1.jsxs)(Col, __assign({ g: 1 }, { children: [(0, jsx_runtime_1.jsx)(fa_1.FaPlusSquare, { style: __assign(__assign({}, iconStyle), { color: props.maxItems && fields.length >= props.maxItems ? 'olive' : 'green' }), onClick: function () { if (!(props.maxItems && fields.length >= props.maxItems)) {
                                        insert(i + 1, emptyRow);
                                    } } }), " ", (0, jsx_runtime_1.jsx)(fa_1.FaMinusSquare, { style: __assign(__assign({}, iconStyle), { color: fields.length > 1 ? 'red' : 'maroon' }), onClick: function () { if (fields.length > 1) {
                                        remove(i);
