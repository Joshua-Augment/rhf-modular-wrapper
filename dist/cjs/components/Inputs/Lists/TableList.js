...
var IconUp = (0, styled_components_1.default)(fa_1.FaPlusSquare)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  color: green;\n  font-size: 1.5em;\n  margin: 2px 5px;\n  transition: 0.2s all ease-in-out;\n  &:hover {\n    filter: brightness(110%);\n    box-shadow: 1px 1px 10px 1px green;\n  }\n"], ["\n  color: green;\n  font-size: 1.5em;\n  margin: 2px 5px;\n  transition: 0.2s all ease-in-out;\n  &:hover {\n    filter: brightness(110%);\n    box-shadow: 1px 1px 10px 1px green;\n  }\n"])));
var IconDown = (0, styled_components_1.default)(fa_1.FaMinusSquare)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  color: red;\n  font-size: 1.5em;\n  margin: 2px 5px;\n  transition: 0.2s all ease-in-out;\n  &:hover {\n    filter: brightness(110%);\n    box-shadow: 1px 1px 10px 1px red;\n  }\n"], ["\n  color: red;\n  font-size: 1.5em;\n  margin: 2px 5px;\n  transition: 0.2s all ease-in-out;\n  &:hover {\n    filter: brightness(110%);\n    box-shadow: 1px 1px 10px 1px red;\n  }\n"])));
var TableList = function (props) {
    var _a;
    return ((0, jsx_runtime_1.jsx)(index_1.InputWrapper, __assign({ type: (_a = props.type) !== null && _a !== void 0 ? _a : "tablelist" }, props, { children: (0, jsx_runtime_1.jsx)(_Table, __assign({}, props)) })));
};
var _Table = function (props) {
    var _a, _b, _c, _d, _e, _f;
    var _g = (0, react_hook_form_1.useFieldArray)({ control: props.control, name: props.name }), fields = _g.fields, append = _g.append, insert = _g.insert, remove = _g.remove;
    ...
    var TableTRTemplate = (_d = props.elemTR) !== null && _d !== void 0 ? _d : TableTR;
    var TableTHTemplate = (_e = props.elemTH) !== null && _e !== void 0 ? _e : TableTH;
    var TableTDTemplate = (_f = props.elemTD) !== null && _f !== void 0 ? _f : TableTD;
    ...
    var bodyGenerator = fields.map(function (field, i) { return ((0, jsx_runtime_1.jsxs)(TableTRTemplate, { children: [props.showIndex === true && (0, jsx_runtime_1.jsx)(TableTDTemplate, { children: i + 1 }), props.items.map(function (item, iT) {
            ...
            }), " ", props.fixed !== true && ((0, jsx_runtime_1.jsxs)(TableTDTemplate, { children: [(0, jsx_runtime_1.jsx)(IconUp, { onClick: function () { return insert(i + 1, emptyRow); } }), " ", (0, jsx_runtime_1.jsx)(IconDown, { onClick: function () {
                            remove(i);
