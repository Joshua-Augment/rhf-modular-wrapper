...
const DropzoneUploader = (props) => {
    return react_1.default.createElement(InputWrapper_1.default, Object.assign({}, props),
        react_1.default.createElement(DropzoneHandler, Object.assign({}, props)));
};
const DropzoneHandler = (props) => {
    ...
    return (react_1.default.createElement(DropzoneContainer, null,
        ...
        props.value && props.value.length > 0 && react_1.default.createElement(PreviewViewer, Object.assign({}, props, { files: props.value, showPreview: showPreview, moveFile: moveFile, handleDelete: handleDelete }))));
};
const PreviewViewer = (props) => {
    const Preview = props.previewBox;
    return props.previewBox && Preview !== undefined ? (react_1.default.createElement(Preview, Object.assign({}, props, { files: props.files }))) : (react_1.default.createElement(PreviewContainer, null, props.files.map((_file, _index) => (react_1.default.createElement(PreviewWrapper, { key: `${props.name}-pr-${_index}` },
        ...
        react_1.default.createElement(ButtonsWrapper, null,
            ...
            react_1.default.createElement(PaginationWrapper, null,
                ...
                react_1.default.createElement(fa_1.FaCaretDown, { title: "Move Down", onClick: () => props.moveFile(_index, 1), style: {
