...
const YesNo = (props) => {
    return (react_1.default.createElement(core_1.InputWrapper, Object.assign({ type: props.yesno }, props, { id: `${props.name}`, noLabel: true, noBorder: true, customClasses: { wrapperClassName: 'form-check' } }),
        react_1.default.createElement(_YesNo, Object.assign({}, props))));
};
const _YesNo = (props) => {
    ...
    const buttonGenerator = (label, valueOfButton, extHandler, ButtonElem, color, key) => {
        return react_1.default.createElement(ButtonElem, { className: props.inputClass, style: Object.assign({}, props.inputStyle), active: valueOfButton === props.value, key: key !== null && key !== void 0 ? key : `yng-${props.name}-${valueOfButton}`, type: "button", onClick: () => buttonHandler(valueOfButton, extHandler), bgColor: color }, label);
    };
