...
const YesNo = (props) => {
    return ((0, jsx_runtime_1.jsx)(InputWrapper_1.default, Object.assign({ type: props.yesno }, props, { id: `${props.name}`, noLabel: true, noBorder: true, customClasses: { wrapperClassName: 'form-check' } }, { children: (0, jsx_runtime_1.jsx)(_YesNo, Object.assign({}, props)) })));
};
const _YesNo = (props) => {
    ...
    const buttonGenerator = (label, valueOfButton, extHandler, ButtonElem, color, key) => {
        return (0, jsx_runtime_1.jsx)(ButtonElem, Object.assign({ className: props.inputClass, style: Object.assign({}, props.inputStyle), active: valueOfButton === props.value, type: "button", onClick: () => buttonHandler(valueOfButton, extHandler), bgColor: color }, { children: label }), key !== null && key !== void 0 ? key : `yng-${props.name}-${valueOfButton}`);
    };
