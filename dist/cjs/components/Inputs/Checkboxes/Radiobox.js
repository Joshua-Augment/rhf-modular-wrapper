...
const Radiobox = (props) => {
    return (react_1.default.createElement(InputWrapper_1.default, Object.assign({}, props, { reversedLabel: true, customClasses: { wrapperClassName: 'form-check' } }), (IWprops) => {
        ...
        return react_1.default.createElement("input", { id: props.name, type: "radio", name: props.name, checked: props.value === IWprops.value, value: props.value, onChange: (a) => IWprops.onChange(props.value) });
    }));
};
