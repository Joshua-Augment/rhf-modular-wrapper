...
const _Checkbox = (props) => {
    ...
    return react_1.default.createElement("input", { id: props.name, type: "checkbox", name: props.name, checked: props.value, value: props.value, onChange: (a) => props.onChange(a.target.checked) });
};
