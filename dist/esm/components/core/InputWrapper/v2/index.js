...
var InputWrapperv2 = function (props) {
    ...
    Logger.info(debug, "Value - ".concat(typeof props.value === 'object' ? JSON.stringify(props.value) : props.value), "".concat(props.name, " - InputWrapperv2"), "start");
    Logger.info(debug, props, "".concat(props.name, " - InputWrapperv2"));
