...
export const useInputValAndError = (name) => {
    ...
    const _d = useFormContext(), { control } = _d, methods = __rest(_d, ["control"]);
    ...
    // }, [_val])
    const _e = useFormState(), { errors, dirtyFields, touchedFields, isValidating, isSubmitting } = _e, allFormStates = __rest(_e, ["errors", "dirtyFields", "touchedFields", "isValidating", "isSubmitting"]);
