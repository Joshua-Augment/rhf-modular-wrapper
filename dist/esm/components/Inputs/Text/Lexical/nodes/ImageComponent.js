...
export default function ImageComponent({ src, altText, nodeKey, width, height, maxWidth, resizable, showCaption, caption, captionsEnabled, }) {
    ...
    return (React.createElement(Suspense, { fallback: null },
        React.createElement(React.Fragment, null,
            ...
            resizable && $isNodeSelection(selection) && isFocused && (React.createElement(ImageResizer, { showCaption: showCaption, setShowCaption: setShowCaption, editor: editor, buttonRef: buttonRef, imageRef: imageRef, maxWidth: maxWidth, onResizeStart: onResizeStart, onResizeEnd: onResizeEnd, captionsEnabled: captionsEnabled })))));
}
