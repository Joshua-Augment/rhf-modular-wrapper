...
var FormList = function (props) {
    var _a;
    return (_jsx(InputWrapper, __assign({ disableController: true, empty: [], type: (_a = props.type) !== null && _a !== void 0 ? _a : "list" }, props, { noBorder: true }, { children: _jsx("div", __assign({ style: { width: "100%" } }, { children: _jsx(_FormWrapper, __assign({}, props)) })) })));
};
    ...
    var bodygenerator = useMemo(function () {
        ...
        return fields.map(function (field, i) {
            ...
            if (props.bodyTemplate !== undefined) {
                ...
                return (_jsxs(Row, { children: [props.showIndex === true && _jsx(Col, __assign({ g: 1 }, { children: i + 1 })), props.items.map(function (item, iT) {
                            var _a;
                            return (_jsx(Col, __assign({ g: (_a = item.grid) !== null && _a !== void 0 ? _a : 12 / (props.items.length + (props.showIndex ? 1 : 0) + (props.fixed !== true ? 1 : 0)) }, { children: _jsx(InputChooser, __assign({}, item, { noBorder: true, name: "".concat(props.name, ".").concat(i, ".").concat(item.name) })) }), "fw-".concat(props.name, "-").concat(i, "-").concat(iT, "-iew")));
                        }), props.fixed !== true && (_jsxs(Col, __assign({ g: 1 }, { children: [_jsx(FaPlusSquare, { style: __assign(__assign({}, iconStyle), { color: props.maxItems && fields.length >= props.maxItems ? "olive" : "green" }), onClick: function () {
                                        if (!(props.maxItems && fields.length >= props.maxItems)) {
                                            insert(i + 1, emptyRow);
                                        }
                                    } }), " ", _jsx(FaMinusSquare, { style: __assign(__assign({}, iconStyle), { color: fields.length > 1 ? "red" : "maroon" }), onClick: function () {
                                        if (fields.length > 1) {
                                            remove(i);
                                        }
