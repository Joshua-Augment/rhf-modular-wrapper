...
import { FieldValues, DeepPartial, ValidationMode, CriteriaMode, FieldError, UseFormReturn } from 'react-hook-form';
...
import { FieldValues as FieldValues$1 } from 'react-hook-form/dist/types';
...
declare const Form: <T extends FieldValues$1>(props: IForm<T>) => react_jsx_runtime.JSX.Element;
