...
const InputInnerWrapper = (props) => {
    ...
    const WrapperMaker = (A, B, children) => {
        ...
        return _jsx("div", Object.assign({ style: { display: "flex", flexDirection: "row" } }, { children: children }));
    };
    ...
    const ChildComponent = _jsxs(React.Fragment, { children: [WrapperElementLeft, ChosenElement
    ...
    return _jsx(ChosenWrapper, { Wrapper: Wrapper, Default: DefaultInputWrapper, props: Object.assign(Object.assign({}, injectProps), { children: ChildComponent }) });
};
const ChosenWrapper = React.memo(({ Wrapper, Default, props }) => {
    return Wrapper ? _jsx(Wrapper, Object.assign({}, props)) : _jsx(Default, Object.assign({}, props));
});
