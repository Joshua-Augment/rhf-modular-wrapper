...
export const Form = (props) => {
    ...
    return (_jsx(ThemeContext.Provider, Object.assign({ value: {
            ...
            elements: elements,
            debug: debug
        } }, { children: _jsx(FormProvider, Object.assign({}, methods, { children: _jsx("form", Object.assign({ onSubmit: methods.handleSubmit(props.onSubmit), id: formID }, { children: props.children })) })) })));
};
export const SubmitButton = (props) => {
    var _a, _b, _c;
    const Wrapper = useContext(ThemeContext).buttonTemplate;
    return Wrapper === null ?
        _jsx("button", Object.assign({ type: "submit", className: `${(_a = props.buttonClass) !== null && _a !== void 0 ? _a : ''}` }, { children: (_c = (_b = props.label) !== null && _b !== void 0 ? _b : props.children) !== null && _c !== void 0 ? _c : '' })) :
        _jsx(Wrapper, Object.assign({}, props));
};
